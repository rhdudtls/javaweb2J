...
<p><br/></p>
<div class="container">
  <h2 class="text-center h1">교환글 검색 결과</h2>
  ...
  <table class="table table-borderless m-0 p-0">
    <tr>
      <td><a href="${ctp}/ChangeList.ch?pag=${pag}&pageSize=${pageSize}" class="btn btn-info btn-sm">돌아가기</a></td>
    </tr>
  </table>
    ...
    <c:forEach var="vo" items="${vos}" varStatus="st">
      <tr>
        ...
        <td class="text-center">
          <c:if test="${sLevel == 0 || vo.openSw == 'OK' || sNickName == vo.nickName}"><a href="${ctp}/ChangeInfo.ch?flag=search&search=${search}&searchString=${searchString}&idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}">${vo.title}</a></c:if>
        ...
        <td>
          ...
          ${fn:substring(vo.writeTime,0,19)}
        </td>
        <td>
          ${vo.readNum}
        </td>
