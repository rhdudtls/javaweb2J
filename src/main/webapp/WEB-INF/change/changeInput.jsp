	...
	<script>
		...
		function fCheck(){
			...
			if(title.trim() == "") {
		  	...
		  	else if(wantSeat.trim() == "") {
		  		alert("원하는 좌석을 입력하세요!");
		  		myform.wantSeat.focus();
		  		return false;
		  	}
		}
...
<p><br/></p>
<div class="container">
	<div class="h1">교환글 작성</div>
	<form name="myform" method="post" action="${ctp}/ChangeInputOk.ch">
      ...
      <tr>
        <th>원하는 좌석</th>
        <td><input type="text" name="wantSeat" id="wantSeat" placeholder="원하는 좌석을 입력하세요 ex)B구역, C10~14 ..." required class="form-control"/></td>
      </tr>
      <tr>
        <th>공개여부</th>
        <td>
      ...
      <tr>
        <td colspan="2" class="text-center">
          <input type="submit" value="글올리기" class="btn btn-primary"/> &nbsp;
          <input type="reset" value="다시입력" class="btn btn-warning"/> &nbsp;
          <input type="button" value="돌아가기" onclick="location.href='${ctp}/ChangeList.ch';" class="btn btn-secondary"/>
        </td>
      </tr>
    </table>
	</form>
