...
<head>
	...
	<script>
		...
		function fCheck() {
			...
			let regTitle = /^(?=.*[a-z0-9가-힣])[a-z0-9A-Z가-힣~@$!%*#?&\s]{2,50}$/;
...
<p><br/></p>
<div class="container">
	<form name="myform" method="post" action="${ctp}/ContentInputOk.co" class="was-validated" enctype="multipart/form-data">
    	<h1 class="text-center" style="font-family: 'KCC-Ganpan'; color:#ff9966">공연정보입력</h1>
    	<br/>
    	<div class="form-group">
			<label for="title">공연 제목 : </label>
			<input type="text" class="form-control" name="title" id="title" placeholder="공연제목을 입력하세요." required autofocus/>
    	</div>
	    <div class="form-group">
			<label for="place">공연 장소 : </label>
			<input type="text" class="form-control" name="place" id="place" placeholder="공연장소를 입력하세요." required/>
	    </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
			...
			<table>
				<tr>
					<th>월요일</th>
					<td><input type="time" name="startTime1" id="startTime1" value="04:00:00" class="form-control" required/></td>
				</tr>
				<tr>
					<th>화요일</th>
					<td><input type="time" name="startTime2" id="startTime2" value="04:00:00" class="form-control" required/></td>
				</tr>
				<tr>
					<th>수요일</th>
					<td><input type="time" name="startTime3" id="startTime3" value="04:00:00" class="form-control" required/></td>
				</tr>
				<tr>
					<th>목요일</th>
					<td><input type="time" name="startTime4" id="startTime4" value="04:00:00" class="form-control" required/></td>
				</tr>
				<tr>
					<th>금요일</th>
					<td><input type="time" name="startTime5" id="startTime5" value="04:00:00" class="form-control" required/></td>
				</tr>
				<tr>
					<th>토요일</th>
					<td><input type="time" name="startTime6" id="startTime6" value="04:00:00" class="form-control" required/></td>
				</tr>
				<tr>
					<th>일요일</th>
					<td><input type="time" name="startTime7" id="startTime7" value="04:00:00" class="form-control" required/></td>
				</tr>
			</table>
	    </div>
	    <div class="form-group">
			<label for="runTime">런타임 : </label>
			<input type="number" class="form-control" name="runTime" id="runTime" placeholder="런타임을 입력하세요." required/>
	    </div>
	    <div class="form-group">
			<label for="age">연령 제한 : </label>
			<input type="text" class="form-control" name="age" id="age" placeholder="연령제한을 입력하세요." required/>
	    </div>
	    <div class="form-group">
			<label for="price">관람 가격 : </label>
			<input type="number" class="form-control" name="price" id="price" placeholder="관람가격을 입력하세요." required/>
		...
		<div class="form-group">
			<div class="form-check-inline">
				...
				<label class="form-check-label">
					<input type="radio" class="form-check-input" name="rsv_type" value="YES" checked>가능
				</label>
			</div>
			<div class="form-check-inline">
				<label class="form-check-label">
				    <input type="radio" class="form-check-input" name="rsv_type" value="NO">불가능
				</label>
			</div>
		</div>
    	<div class="form-group">
			<label for="content">공연소개</label>
			<textarea rows="5" class="form-control" id="content" name="content" placeholder="공연소개를 입력하세요." required></textarea>
		</div>
		<div class="form-group">
		    공연 사진(파일용량:2MByte이내) :
		...
		<button type="button" class="btn btn-success" onclick="fCheck()">공연등록</button> &nbsp;
		<button type="reset" class="btn btn-warning">다시작성</button> &nbsp;
		<button type="button" class="btn btn-info" onclick="location.href='${ctp}/ContentList.co';">돌아가기</button>
	</form>
</div>
<p><br/></p>
