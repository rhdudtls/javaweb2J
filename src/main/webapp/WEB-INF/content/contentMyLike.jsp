	        ...
	        <div class="card-columns">
	        	<c:forEach var="vo" items="${vos}" varStatus="st">
	                <div class="card h-100 mb-4">
	                    <a href="${ctp}/ContentInfo.co?idx=${vo.idx}&flag=myLike">
	                        <img src="${ctp}/assets/img/content/${vo.photo}" class="card-img-top" height="280px">
	                    </a>
	                    <div class="card-body this_month">
	                        <a href="${ctp}/ContentInfo.co?idx=${vo.idx}&flag=myLike" class="h2_1 text-decoration-none text-dark">${vo.title}</a>
