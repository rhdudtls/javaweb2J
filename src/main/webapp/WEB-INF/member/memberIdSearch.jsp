	...
	<section class="container py-5">
	    <div class="row text-center pt-5 pb-3">
	        <div class="col-lg-6 m-auto" style="background-color:#F5F0BB">
	            <h1>아이디 찾기</h1>
	            <p>이름과 이메일 주소를 정확하게 입력해주세요!</p>
	        </div>
	    </div>
	    <form name="myform">
		    <div class="text-center">
		    	이름 : &nbsp;<input type="text" name="name" id="name" class="mb-3 ml-2"/><br/>
		    	이메일 : <input type="text" name="email" id="email" class="mb-3"/><br/>
			    <input type="button" value="아이디 찾기" onclick="idSearch()" class="btn btn-primary"/>
