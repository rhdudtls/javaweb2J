  ...
  <div class="modal-dialog">
	  <div class="modal-content p-4">
		  ...
		  <form name="myform" method="post" action="${ctp}/MemberLoginOk.mem" class="was-validated">
		    ...
		    <div class="row text-center member_a">
		      <span class="col" style="font-size:17px"><input type="checkbox" name="idSave" checked />아이디 저장</span>
		      <span class="col" style="font-size:14px">
		        [<a href="${ctp}/MemberIdSearch.mem"><span style="font-size:15px;">아이디찾기</span></a>] /
		        [<a href="${ctp}/MemberPwdSearch.mem"><span style="font-size:15px;">비밀번호찾기</span></a>]
		      </span>
		    </div>
		  </form>
	  </div>
