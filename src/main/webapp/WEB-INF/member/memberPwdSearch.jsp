	...
	<section class="container py-5">
	    <div class="row text-center pt-5 pb-3">
	        <div class="col-lg-6 m-auto" style="background-color:#F5F0BB">
	            <h1>비밀번호 찾기</h1>
	            <p>아이디와 이메일 주소를 정확하게 입력해주세요!</p>
	        </div>
	    </div>
	    <form name="myform" method="post" action="${ctp}/MemberPwdSearchOk.mem">
		    <div class="text-center">
		    	아이디 : <input type="text" name="mid" id="mid" class="mb-3"/><br/>
		    	이메일 : <input type="text" name="email" id="email" class="mb-3"/><br/>
			    <input type="button" value="비밀번호 찾기" onclick="pwdSearch()" class="btn btn-primary"/>
