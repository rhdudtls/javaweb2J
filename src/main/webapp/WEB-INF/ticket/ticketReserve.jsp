	...
	<div class="row text-center py-3">
         <div class="col-lg-6 m-auto">
             ...
             <p class="banner_content">
               	~예매할 공연을 선택하세요~<br/>
               	더 자세한 공연 정보는 상단의 공연탭에서 확인하세요!
             </p>
         </div>
	</div>
	<div class="card-columns">
       	<c:forEach var="vo" items="${vos}" varStatus="st">
               <c:if test="${vo.rsv_type == 'YES'}"><div class="card h-100 mb-4">
                   <a href="${ctp}/TicketReserveDate.ti?idx=${vo.idx}">
                       <img src="${ctp}/assets/img/content/${vo.photo}" class="card-img-top" height="280px">
                   </a>
               <div class="card-body this_month">
                   <a href="${ctp}/TicketReserveDate.ti?idx=${vo.idx}" class="h2_1 text-decoration-none text-dark">${vo.title}</a>
